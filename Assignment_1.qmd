...
rolling %>% 
  ...
  labs(title="Global temperature changes over time", color="Location", y="Temperature in celsius", x= "Year")+ #We add the title, change legend name to location and set Y and X axis 
