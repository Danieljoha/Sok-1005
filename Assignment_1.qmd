...
rolling %>% 
  ...
  geom_line(aes(y=rolling_lower, color="Lower atmosphere"))+ #we set lines for all the different variables
  ...
  labs(title="Temperature over time", color="Location", y="Temperature", x= "Year")+ #We add the title, change legend name to location and set Y and X axis 
