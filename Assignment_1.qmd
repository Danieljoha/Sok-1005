...
rolling %>% 
  ...
  labs(title="Global temperature changes over time", color="Location", y="Temperature in celsius", x= "Year", subtitle="The graph shows the temperature deviation from the 1991-2020 average.")+ #We add the title, change legend name to location and set Y and X axis 
