...
rolling %>% 
  ...
  labs(title="Global temperature changes over time", color="Location", y="Temperature in celsius", x= "Year", subtitle="The graph shows the temperature deviation from the 1991-2020 average.", caption="Source: www.drroyspencer.com/latest-global-temperatures/")+ #We add the title and subtitle, change legend name to location, set caption and set Y and X axis
