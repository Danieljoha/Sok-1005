...
stratosphere <- stratosphere[1:which(stratosphere$Year %in% "Year")-1, ] #We remove all rows above the second "Year" in the table.
...
rolling %>% 
  ...
  labs(title="Global temperature changes over time", color="Location", y="Temperature in celsius", x= "Year", subtitle="The graph shows the temperature deviation from the 1991-2020 average.
The graph shows right aligned rolling averages", caption="Source: www.drroyspencer.com/latest-global-temperatures/")+ #We add the title and subtitle, change legend name to location, set caption and set Y and X axis
