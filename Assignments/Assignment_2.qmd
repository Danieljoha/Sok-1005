...
The blue line plots the linear regression from the data points from the range test. We can see that the blue line is flatter than the red line showing that the higher the stated range is, the larger the deviation will be in the range test.
